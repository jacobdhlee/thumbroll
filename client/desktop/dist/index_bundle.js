...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Classes = __webpack_require__(223);

	var _Classes2 = _interopRequireDefault(_Classes);

	var _ClassData = __webpack_require__(224);

	var _ClassData2 = _interopRequireDefault(_ClassData);

	var _LessonData = __webpack_require__(225);

	var _LessonData2 = _interopRequireDefault(_LessonData);

	var _StudentData = __webpack_require__(226);

	var _StudentData2 = _interopRequireDefault(_StudentData);

	var _Settings = __webpack_require__(227);
	...
	_reactDom2.default.render(_react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.IndexRoute, { component: _Classes2.default, onEnter: requireAuth }),
	    _react2.default.createElement(_reactRouter.Route, { path: '/profile', component: _Profile2.default, onEnter: requireAuth }),
	    _react2.default.createElement(_reactRouter.Route, { path: 'class/:classId/lessons', component: _ClassData2.default, onEnter: requireAuth }),
	    _react2.default.createElement(_reactRouter.Route, { path: 'class/:classId/lessons/:lessonId', component: _LessonData2.default, onEnter: requireAuth }),
	    _react2.default.createElement(_reactRouter.Route, { path: 'class/:classId/students/:studentId', component: _StudentData2.default, onEnter: requireAuth })
	  ),
	      ...
	      _auth2.default.login(this.state.username, this.state.password, function (success) {
	        if (success) {
	          ...
	          if (_this2.props.location.state) {
	            var nextPage = _this2.props.location.state.nextPathName;
	            _this2.context.router.replace(nextPage);
	            return;
	          } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var env = __webpack_require__(221);
	  ...
	  _createClass(ClassData, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(Lessons, { lessons: this.state.lessons, display: this.state.displayLessons, classId: this.state.classId }),
	        _react2.default.createElement(Students, { students: this.state.students, display: this.state.displayStudents, classId: this.state.classId })
	      );
	    }
	  }, {
	    key: 'componentWillMount',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LessonData = function (_React$Component) {
	  _inherits(LessonData, _React$Component);

	  function LessonData(props) {
	    _classCallCheck(this, LessonData);
